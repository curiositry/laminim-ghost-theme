Array.prototype.forEach.call(document.querySelectorAll('form[data-members-form]'), function (form){
    ...
    function submitHandler(event) {
        ...
        fetch('https://curiositry.com/laminim-ghost-theme/ghost/api/canary/members/send-magic-link/', {
            method: 'POST',
            headers: {
...
Array.prototype.forEach.call(document.querySelectorAll('[data-members-plan]'), function (el) {
    ...
    function clickHandler(event) {
        ...
        fetch('https://curiositry.com/laminim-ghost-theme/members/ssr', {
            ...
            return fetch('https://curiositry.com/laminim-ghost-theme/ghost/api/canary/members/create-stripe-checkout-session/', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
